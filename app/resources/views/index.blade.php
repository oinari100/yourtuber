...
<head>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-R0JVGD7M3K"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());
  
    gtag('config', 'G-R0JVGD7M3K');
  </script>
</head>
<body>
  <div id="app"></div>
